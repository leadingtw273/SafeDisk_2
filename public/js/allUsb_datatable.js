...
$(document).ready(function () {
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    let key = data.usbKey;
                    let html = synValue + ' <button type="button" name="' + key + '" class="btn btn-success btn-xs dt-edit" data-toggle="modal" data-target="#myEditModal"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>';
                    return html;
                }
            }
        ]
    ...
    // 按鈕設定
    $('.data-newOrder').attr('data-toggle', 'modal').attr('data-target', '#myNewModal');

    $('#newUsb-from').bootstrapValidator({
    ...
    $('#showUsb-from').bootstrapValidator({
            message: 'This value is not valid',
            feedbackIcons: {
                valid: 'glyphicon glyphicon-ok',
                invalid: 'glyphicon glyphicon-remove',
